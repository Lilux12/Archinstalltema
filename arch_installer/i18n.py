...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "ru": {
        ...
        "stage.8": "Сеть и DNS",
        "stage.9": "Инструменты разработки",
        "stage.10": "Udev-правила микроконтроллеров",
        "stage.11": "AUR helper и авто-обновления",
        "stage.12": "Драйвер NVIDIA (AUR)",
    ...
    "en": {
        ...
        "stage.8": "Network and DNS",
        "stage.9": "Development tools",
        "stage.10": "Udev rules for microcontrollers",
        "stage.11": "AUR helper and auto-updates",
        "stage.12": "NVIDIA driver (AUR)",
